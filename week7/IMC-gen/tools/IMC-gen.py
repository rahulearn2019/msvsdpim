...
shutil.copyfile(
    srcDir + "SRAMLOGIC.v", flowDir + "design/src/imc/SRAMLOGIC.v"
)
shutil.copyfile(
    srcDir + "MUX2_1.v", flowDir + "design/src/imc/MUX2_1.v"
)
shutil.copyfile(
    srcDir + "imc.v", flowDir + "design/src/imc/" + designName +
".v"
)
...
subprocess.run(["ls", "-l", flowDir, "results/", args.platform, "/imc"])

shutil.copyfile(
    flowDir + "results/" + args.platform + "/imc/6_final.gds",
...
shutil.copyfile(
    flowDir + "results/" + args.platform + "/imc/6_final.v",
    outputDir + "/" + designName + ".v",
)
shutil.copyfile(
    flowDir + "results/" + args.platform + "/imc/6_1_fill.sdc",
