...
parser = argparse.ArgumentParser(description="asyn_up_counter design generator")
parser.add_argument(
    "--specfile",
    required=True,
...
if jsonSpec["generator"] != "avsd4bituc-gen":
    print('Error: Generator specification must be "avsd4bituc-gen".')
    sys.exit(1)
...
#mFilePublic1 = genDir + args.platform + ".model_asyn_up_counter"
