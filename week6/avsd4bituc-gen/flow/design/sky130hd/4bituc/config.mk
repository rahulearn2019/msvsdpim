...
export ADDITIONAL_LEFS  	= ../blocks/$(PLATFORM)/lef/adc1.lef \
                        	  ../blocks/$(PLATFORM)/lef/osc1.lef

export ADDITIONAL_GDS_FILES 	= ../blocks/$(PLATFORM)/gds/adc1.gds \
			      	  ../blocks/$(PLATFORM)/gds/osc1.gds
